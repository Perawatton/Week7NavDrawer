    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            manager.beginTransaction()
                    ...
                    .replace(R.id.relativelayount_for_fragment,
                    cameraFragment,
                    cameraFragment.getTag()
            ).commit();
           /* CameraFragment cameraFragment = new CameraFragment();
            FragmentManager manager  = getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.relativelayount_for_fragment,cameraFragment)
                    .commit();*/
            ...
            manager.beginTransaction()
                    .setCustomAnimations(R.anim.anim_slide_in_from_left, R.anim.anim_slide_out_from_left)
                    .replace(R.id.relativelayount_for_fragment,galleryFragment)
                    .commit();
            ...
            manager.beginTransaction()
                    .setCustomAnimations(R.anim.anim_slide_in_from_left, R.anim.anim_slide_out_from_left)
                    .replace(R.id.relativelayount_for_fragment,blankFragment)
                    .commit();
